...
public class NearbyCrossPlugin: NSObject, FlutterPlugin {
    ...
    init(channel: FlutterMethodChannel, context: UIApplication) {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "com.example.nearby_cross", binaryMessenger: registrar.messenger())
        let context = UIApplication.shared
        let instance = NearbyCrossPlugin(channel: channel, context: context)
